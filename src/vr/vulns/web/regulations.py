...
from vr.vulns.model.regulations import Regulations, MakeRegulationsSchema, RegulationsSchema
...
def all_regulations():
    try:
        ...
        return render_template('all_regulations.html', entities=assets, user=user, NAV=NAV)
    except RuntimeError:
