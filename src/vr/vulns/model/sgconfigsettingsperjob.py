...
class SgConfigSettingsPerJob(db.Model):
    ...
    def __repr__(self):
        return '<SgConfigSettingsPerJob(name={self.AppID!r})>'.format(self=self)

class SgConfigSettingsPerJobSchema(Schema):
    ID = fields.Int()
    AppID = fields.Int()
...
class MakeSgConfigSettingsPerJobSchema(SgConfigSettingsPerJobSchema):
    @post_load
    def make_it(self, data, **kwargs):
        return SgConfigSettingsPerJob(**data)
