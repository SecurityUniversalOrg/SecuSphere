...
from config_engine import JENKINS_USER, JENKINS_PW, JENKINS_KEY, JENKINS_PROJECT, JENKINS_HOST
...
def jenkins_webhook():
    ...
    if ref.startswith('refs/heads/security/'):
        ...
        resp = requests.get(url, headers, auth=HTTPBasicAuth(JENKINS_USER, JENKINS_PW))
